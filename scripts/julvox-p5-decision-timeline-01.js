...
(function julvoxP5DecisionTimeline01(){
  ...
  document.addEventListener('keydown',function(event){var timeline=document.getElementById('julvoxP5DecisionTimeline');if(event.key==='Escape'&&timeline&&!timeline.hidden){event.preventDefault();closeTimeline()}},true);
})();
</script>`;
